...
urlpatterns = [
    ...
    path('dashboard/unread-count/',         views.get_unread_count,     name='unread_count'),
    path('trainer/booked-slots/<int:trainer_id>/', views.get_booked_slots, name='booked_slots'),
    ...
    path('feed/post/',             views.feed_create_post,   name='feed_create_post'),
    path('feed/like/',             views.feed_toggle_like,   name='feed_toggle_like'),
    path('feed/comment/',          views.feed_add_comment,   name='feed_add_comment'),
